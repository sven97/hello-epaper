...
// LED policy (active-LOW pin): Solid = awake between operations (dev-mode
// idle parks at Off), Heartbeat = busy (fetching / dithering / refreshing
// the panel — proof it isn't hung), Off = about to sleep. A tiny FreeRTOS
// task owns the pin; ack blinks (blinkLed) temporarily take it over.
